...
> **자동 생성 대시보드** (`scripts/gen_dashboard.py`, 2026-07-13 20:14). 직접 편집 금지 — 카드/원장을 고치고 재생성.
...
| 날짜 | 런 | 캠페인 | 상태 | 로딩 기법 수 |
|---|---|---|---|---|
| 2026-07-13 | [canvas 세션 10 — P1 크로스-페이스트 파일럿](runs/2026-07-13-canvas-p1-crosspaste.md) | canvas | running | 6 |
